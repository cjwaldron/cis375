...
namespace cis375projectmysqlDB
{
    public partial class item : System.Web.UI.Page
    {
        ...
        string connStr = "Server=localhost;Port=3306;Database=cis375project;Uid=root;password=root;";
...
///////////////////////////////////////////////////////////
        ...
        protected void buyitnowBT_Click(object sender, EventArgs e)
        {
            ...
            dataReader2.Close();
            // add item to sold
            cmd = new MySqlCommand("INSERT INTO sold (itemid, price) VALUES(@a,@b) UPDATE item SET price = @b WHERE itemid = @a", connection); 
